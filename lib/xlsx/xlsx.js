...
class XLSX {
  ...
  async _processDrawingEntry(entry, model, name) {
    ...
    // Fall back to an empty drawing for parts whose root element was not
    // recognised by DrawingXform. This keeps worksheet references intact
    // and avoids null dereferences during reconcile.
    model.drawings[name] = drawing || {anchors: []};
  }

...
class DrawingXform extends BaseXform {
  ...
  parseOpen(node) {
    ...
    // Seed a safe default so unrecognised root elements (e.g. <c:userShapes>
    // chart overlays, or <wsDr> using the default namespace instead of the
    // xdr: prefix) still produce a usable empty model rather than null.
